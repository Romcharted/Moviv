<template>
    <div class="home-intro">
        ...
        <HomeSliderPopularNow :movies="movies" @movieChange="updateMovie" />
    </div>
</template>
...
const moviesData = [
    ...
    },
    {
        ...
        popularity: 688.881,
        poster_path: "/21bclfc5wu3W5aQ4KZN9qHPmQri.jpg",
...
const movie = ref<Movie>(movies[0]);

const updateMovie = (newMovie: number) => {
    movie.value = movies[newMovie];
};
</script>
